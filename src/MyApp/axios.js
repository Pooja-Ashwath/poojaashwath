...
function Axios(props){
    ...
    const [arr, setArr] = useState({});
     useEffect(()=>{
        const f = async ()=>{
            const res = await axios.get(`https://jsonplaceholder.typicode.com/posts/${props.Id1 ? props.Id1 : 2}/`);
            return res;
        }
...
if(payload2.Id1){
    ...
    const f1 = async (p)=>{
        const func = await axios.post("https://jsonplaceholder.typicode.com/posts", p);
